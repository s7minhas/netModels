\documentclass[12pt,onesided,pdflatex]{amsart} 
...
\hypersetup{%
	...
	pdftitle={AMEN for Latent Factor Models},%
	colorlinks,%
	citecolor=black,%
	filecolor=black,%
	linkcolor=black,%
...
\email[Corresponding author]{shahryar.minhas@duke.edu}
...
\thanks{This research was partially supported by the National Science Foundation Award 1259266.}
