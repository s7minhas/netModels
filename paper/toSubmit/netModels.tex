...
Further if one has specified the ``correct'' set of network statistics, then our ability to conduct inference on exogenous parameters also improves relative to GLM. 
