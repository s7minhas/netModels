...
We next convert the joint probability into a likelihood by assuming the observations are fixed but the distributional parameters, $\bm{\theta}$, are assumed to be random:%\footnote{For further discussion see \citet{ward:ahlquist:2010} or other introductory sources to maximum-likelihood estimation.}
