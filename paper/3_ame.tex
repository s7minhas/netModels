...
In the following section we undertake a comparison of the approaches described here using an application chosen by \citet{cranmer:etal:2016}. In doing so, we are able to highlight the benefits that the AME model provides over alternatives such as ERGM and the latent distance model.
