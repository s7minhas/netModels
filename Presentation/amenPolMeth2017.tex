...
\frame{frametitle{Why Euclid Was Wrong.}
\begin{itemize}
\item First, social distances may not be Euclidean. We know distances among preferences are not.
\item doh
\item reh
\item mi
\end{itemize}
...
\begin{itemize}
  \item - randomly select a network by sampling on links.  Tricky for ERGM.
