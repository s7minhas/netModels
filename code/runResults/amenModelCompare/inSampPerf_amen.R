...
amePred0 = getAmePred('ameFit_0.rda')
amePred1 = getAmePred('ameFit_1.rda')
amePred2 = getAmePred('ameFit_2.rda')
amePred3 = getAmePred('ameFit_3.rda')
amePred4 = getAmePred('ameFit_4.rda')
################################################
...
print.xtable( xtable(aucSumm, align='lcc', 
	...
	size='normalsize', file=paste0(graphicsPath, 'aucTable_ame.tex') )
...
ggsave(tmp, file=paste0(graphicsPath, 'roc_ame.pdf'), width=5, height=5, device=cairo_pdf)
...
ggsave(tmp, file=paste0(graphicsPath, 'rocPr_ame.pdf'), width=5, height=5, device=cairo_pdf)
################################################
...
# Organize pred DFs
predDfs = list(
	'AME SR (k=0)'=amePred0,  'AME SR (k=1)'=amePred1, 'AME SR (k=2)'=amePred2,
	'AME SR (k=3)'=amePred3, 'AME SR (k=4)'=amePred4 )
