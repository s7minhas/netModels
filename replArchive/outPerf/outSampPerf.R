...
################################################
# load mod results
if( !file.exists( paste0(resultsPath,'predData_outSample.rda') ) ){
	...
	save(predDfs, file=paste0(resultsPath,'predData_outSample.rda'))	
	} else {
	load(paste0(resultsPath,'predData_outSample.rda'))
	}
################################################
